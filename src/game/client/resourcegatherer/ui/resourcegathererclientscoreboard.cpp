...
// Purpose: Konstructor
//-----------------------------------------------------------------------------
CResourceGathererClientScoreBoardDialog::CResourceGathererClientScoreBoardDialog(IViewPort *pViewPort):CClientScoreBoardDialog(pViewPort)
{
}
...
// Purpose: Destructor
//-----------------------------------------------------------------------------
CResourceGathererClientScoreBoardDialog::~CResourceGathererClientScoreBoardDialog()
{
}
...
//-----------------------------------------------------------------------------
void CResourceGathererClientScoreBoardDialog::PaintBackground()
{
...
//-----------------------------------------------------------------------------
void CResourceGathererClientScoreBoardDialog::PaintBorder()
{
	int x1, x2, y1, y2;
...
//-----------------------------------------------------------------------------
void CResourceGathererClientScoreBoardDialog::ApplySchemeSettings( vgui::IScheme *pScheme )
{
...
//-----------------------------------------------------------------------------
void CResourceGathererClientScoreBoardDialog::InitScoreboardSections()
{
	m_pPlayerList->SetBgColor( Color(0, 0, 0, 0) );
	m_pPlayerList->SetBorder(NULL);
...
//-----------------------------------------------------------------------------
void CResourceGathererClientScoreBoardDialog::UpdateTeamInfo()
{
	if ( g_PR == NULL )
		return;
...
//-----------------------------------------------------------------------------
void CResourceGathererClientScoreBoardDialog::AddHeader()
{
	// add the top header
...
//-----------------------------------------------------------------------------
void CResourceGathererClientScoreBoardDialog::AddSection(int teamType, int teamNumber)
{
	HFont hFallbackFont = scheme()->GetIScheme( GetScheme() )->GetFont( "DefaultVerySmallFallBack", false );
...
int CResourceGathererClientScoreBoardDialog::GetSectionFromTeamNumber( int teamNumber )
{
	switch ( teamNumber )
	{
	case TEAM_SPECTATOR:
...
//-----------------------------------------------------------------------------
bool CResourceGathererClientScoreBoardDialog::GetPlayerScoreInfo(int playerIndex, KeyValues *kv)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CResourceGathererClientScoreBoardDialog::UpdatePlayerInfo()
{
