...
enum ResourceGathererPlayerState
{
...
#define CResourceGatherer_Player C_ResourceGatherer_Player
#endif
...
public:
	...
	CPlayerAnimState( CResourceGatherer_Player *outer );
	...
	CResourceGatherer_Player		*GetOuter();
...
private:
	...
	CResourceGatherer_Player		*m_pOuter;
