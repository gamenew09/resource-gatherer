...
const char *CResourceGatherer_Player::GetPlayerModelSoundPrefix( void )
{
	return g_ppszPlayerSoundPrefixNames[m_iPlayerSoundType];
}

void CResourceGatherer_Player::PrecacheFootStepSounds( void )
{
...
//-----------------------------------------------------------------------------
Vector CResourceGatherer_Player::GetAttackSpread( CBaseCombatWeapon *pWeapon, CBaseEntity *pTarget )
{
	if ( pWeapon )
...
//-----------------------------------------------------------------------------
void CResourceGatherer_Player::PlayStepSound( Vector &vecOrigin, surfacedata_t *psurface, float fvol, bool force )
{
...
CPlayerAnimState::CPlayerAnimState( CResourceGatherer_Player *outer )
	: m_pOuter( outer )
{
	m_flGaitYaw = 0.0f;
...
// Output : CBasePlayer
//-----------------------------------------------------------------------------
CResourceGatherer_Player *CPlayerAnimState::GetOuter()
{
	return m_pOuter;
}
