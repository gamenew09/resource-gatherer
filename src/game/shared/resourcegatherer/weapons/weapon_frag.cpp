...
//-----------------------------------------------------------------------------
class CWeaponFrag: public CBaseResourceGathererCombatWeapon
{
	DECLARE_CLASS( CWeaponFrag, CBaseResourceGathererCombatWeapon );
public:
...
//	vForward[0] += 0.1f;
	...
	if ( pGrenade )
	{
		...
		pGrenade->SetDamage( GetRGWpnData().m_iPlayerDamage );
