...
void CPlayerPickupController::Init( CBasePlayer *pPlayer, CBaseEntity *pObject )
{
	...
	CResourceGatherer_Player *pOwner = (CResourceGatherer_Player *)ToBasePlayer( pPlayer );
	if ( pOwner )
	{
...
void CPlayerPickupController::Shutdown( bool bThrown )
{
	...
	if ( m_pPlayer )
	{
		CResourceGatherer_Player *pOwner = (CResourceGatherer_Player *)ToBasePlayer( m_pPlayer );
		if ( pOwner )
		{
...
class CWeaponPhysCannon : public CBaseResourceGathererCombatWeapon
{
public:
	DECLARE_CLASS( CWeaponPhysCannon, CBaseResourceGathererCombatWeapon );
...
bool CWeaponPhysCannon::AttachObject( CBaseEntity *pObject, const Vector &vPosition )
{
	...
	CResourceGatherer_Player *pOwner = (CResourceGatherer_Player *)ToBasePlayer( GetOwner() );
