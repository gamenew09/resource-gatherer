...
class CWeaponCrossbow : public CBaseResourceGathererCombatWeapon
{
	DECLARE_CLASS( CWeaponCrossbow, CBaseResourceGathererCombatWeapon );
public:
...
void CWeaponCrossbow::FireBolt( void )
{
	...
	CCrossbowBolt *pBolt = CCrossbowBolt::BoltCreate( vecSrc, angAiming, GetRGWpnData().m_iPlayerDamage, pOwner );
